...
# Arquivos fonte
SOURCES_THREADS = main_threads.c trader.c executor.c price_updater.c arbitrage_monitor.c
SOURCES_PROCESSOS = main_processos.c trader.c executor.c price_updater.c arbitrage_monitor.c
...
# Regra padrão
all: $(TARGET_THREADS) $(TARGET_PROCESSOS)
...
clean:
	rm -f $(OBJECTS_THREADS) $(OBJECTS_PROCESSOS) $(TARGET_THREADS) $(TARGET_PROCESSOS)
	rm -f *.o
